...
public class JanelaCartao extends JFrame {
    ...
    public void mudarCartao(Cartao c) {
        cardAtual = c;
        // TODO FEITO é preciso atualizar os cupões feito
        c.atualizarCupoes(); 

        // TODO FEITO é preciso colocar a informação certa nas variáveis feito
    ...
    public void desenharCupao(Graphics g, RendererCupoes rendererCupoes, Cupao cupao) {
        // TODO FEITO colocar os dados certos nas variáveis feito
        String resumo = cupao.getDescricao();
        float desconto = (float)cupao.getDesconto() /100;
        LocalDate comeca = cupao.getDataInicio();
        LocalDate acaba = cupao.getDataFim();
    ...
    private void ativarCartao(List<Cupao> cupoesSelecionados) {
        // TODO FEITO ativar o cartão com os cupões selecionados 
        if(cardAtual!=null)
    ...
    private final class RendererCartoes extends DefaultListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected,
            ...
            // TODO FEITO colocar a informação certa na variável feito
